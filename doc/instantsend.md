...
This mechanism has been integrated into Bitcore-Node-Compass which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/compasspay/insight-api-compass#web-socket-api](https://github.com/compasspay/insight-api-compass#web-socket-api)
* API: [https://github.com/compasspay/insight-api-compass#instantsend-transactions](https://github.com/compasspay/insight-api-compass#instantsend-transactions)
...
By default, the Compass Coin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Compass Coin daemon:
