...
Compass Coin is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 1444.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 1445 for connections and services them.
...
However, in open source software such as Compass Coin, where everyone uses
...
pay attention to for reviewers of Compass Coin code.

General Compass Coin
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Compass Coin uses tinyformat, which is type safe. Leave them out to avoid confusion
