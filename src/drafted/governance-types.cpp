...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CompassNetwork") type = CompassNetwork;
    if(strType == "CompassNetworkVariable") type = CompassNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CompassNetwork) s = "CompassNetwork";
    if(type == CompassNetworkVariable) s = "CompassNetworkVariable";
