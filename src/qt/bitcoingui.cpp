    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Compass Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and compass: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Compass Coin"), this);
    aboutAction->setStatusTip(tr("Show information about Compass Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Compass Coin"));
    ...
    openAction->setStatusTip(tr("Open a compass: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Compass Coin help message to get a list with possible Compass Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Compass Coin client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Compass Coin"); // default title
