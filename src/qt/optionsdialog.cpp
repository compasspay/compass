    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Compass-light"), QVariant("light"));
    // ui->theme->addItem(QString("Compass-light-hires"), QVariant("light-hires"));
    // ui->theme->addItem(QString("Compass-blue"), QVariant("drkblue"));
    // ui->theme->addItem(QString("Compass-Crownium"), QVariant("crownium"));
    // ui->theme->addItem(QString("Compass-traditional"), QVariant("trad"));
