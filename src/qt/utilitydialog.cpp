    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Compass Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Compass Coin"));
...
All the Compass in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CSS, 0.1 CSS, 1 CSS and 10 CSS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://compass.atlassian.net/wiki/display/DOC/PrivateSend\">https://compass.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Compass Coin is shutting down...") + "<br /><br />" +
