...
COIN_NAME="Compass Coin"
coin_name="compass"
COIN_DATA="compasscoin"
COIN_PORT=1444
...
COIN_TGZ="https://github.com/compasspay/compass/releases/download/v1.0.0.0/compasscoin-1.0.0-linux${KERN_ARCH}.tar.gz"
